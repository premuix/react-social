  ...
  <header className="header-custom">
          <div className="container-fluid light-bg">
            <div className="container">
              <div className="social-strip d-flex justify-content-end align-items-center">
                <div><a href="/"><img src="./assets/images/icon-github.svg" alt="git" /></a></div>
                <div><a href="/"><img src="./assets/images/icons-linkedin.svg" alt="linkedin" /></a></div>
                <div><a href="/"><img src="./assets/images/icons-twitter.svg" alt="twitter" /></a></div>
              </div>
            </div>
          </div>
          ...
          <nav className="sw-nav navbar navbar-expand-lg navbar-light">
            <div className="container px-0 px-xl-3">
              <a className="navbar-brand" href="/"><img title="my-img" src="/assets/images/logoSocialWell.svg" alt="SocialWell" /></a>
